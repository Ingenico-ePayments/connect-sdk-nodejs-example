...
var createRefundCaptureStub = require("./stubs/captures/refund.json");
...
app.get("/captures/refund/:captureId", function (req, res) {
  connectSdk.captures.refund(merchantId, req.params.captureId, createRefundCaptureStub, null, function (error, sdkResponse) {
    render(res, error, sdkResponse);
  });
});
